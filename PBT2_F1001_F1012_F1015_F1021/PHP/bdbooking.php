...
<html>
    <head>
        <title>INAP DESA BOOKING SUCESSFULL</title>                                                             <!-- Web Title -->
    ...
    <body>
        ...
        ?>
    <table>                                                                                                     <!-- Table -->
            <form action=../HTML/hotelbook.html method="post">                                                                                              <!-- Form on submit to # with method post -->
                <tr>                                                                                            <!-- ROW 1 -->
                ...
                <tr id="tabphp">                                                                                <!-- ROW 14 -->
                    <td colspan="7" align="center" >                                                            <!-- COL 1-7 -->
                        <h2>YOUR BOOKING WAS SUCSESSFULL</h2>
                    </td>
                </tr>
                <tr id="tabphp">                                                                                <!-- ROW 14 -->
                    <td colspan="7" align="center">                                                             <!-- COL 1-7 -->
                        <!--content in COL 1-7 (link to hotelbook.html) and style for <a> and <a:hover> -->
                        <input type="submit"  id="btn" value="CANCEL BOOK" name="cancel"
                        ...
                        this.style.color='black';" 
                        onsubmit="<?php
                        include 'deldata.php.php';                                                                    //INCLUDE CONTENT IN bdbooking.php
                        ?>"
                    >
                    </td>
                </tr>
